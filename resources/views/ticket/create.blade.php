        ...
        <div class="flex-1 overflow-y-auto px-6 py-6">
            ...
            <div class="complaint-card">
                <form class="complaint-form" method="POST" action="#">
                    @csrf
                    <div>
                        <label class="complaint-field-label" for="ticket_id">Ticket ID</label>
                        <input id="ticket_id" name="ticket_id" type="text" class="complaint-input" placeholder="Auto-generated or custom ticket ID" required>
                    </div>

                    <div>
                        <label class="complaint-field-label" for="title">Title</label>
                        <input id="title" name="title" type="text" class="complaint-input" placeholder="Enter ticket title" required>
                    </div>

                    <div>
                        <label class="complaint-field-label" for="description">Description</label>
                        <textarea id="description" name="description" rows="6" class="complaint-textarea" placeholder="Describe the complaint in detail..." required></textarea>
                    </div>

                    <div>
                        <label class="complaint-field-label" for="issuer_id">Issuer ID</label>
                        <input id="issuer_id" name="issuer_id" type="number" class="complaint-input" value="{{ auth()->id() ?? '' }}" placeholder="Authenticated user ID" required>
                    </div>

                    <div>
                        <label class="complaint-field-label" for="date">Date</label>
                        <input id="date" name="date" type="date" class="complaint-input" required>
                    </div>
                    ...
                    <div>
                        <label class="complaint-field-label" for="assigned_to">Assigned To</label>
                        <input id="assigned_to" name="assigned_to" type="number" class="complaint-input" placeholder="Assigned staff/user ID">
                    </div>
